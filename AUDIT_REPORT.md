# HexForge Platform Audit Report (Heightmap & GlyphEngine)
...
heightmap engine, glyph (surface) engine, a media API, MongoDB, and an Ollama LLM container.
...
glyphengine. Alias directives map `/assets/heightmap/` to `/var/www/hexforge3d/output/` and
