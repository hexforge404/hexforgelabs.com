...
const products = [
  ...
  {
    name: 'Custom Family Lithophane Bundle',
    sku: 'LITHBUNDLE01',
    slug: 'custom-family-lithophane-bundle',
    description: 'Four-image family lithophane bundle with two 4-panel lamps, two diffuser inserts, and four matching night lights.',
    price: 299.99,
    image: '/images/products/litho-multipanel/hero-main.jpg',
    imageGallery: [
      '/images/products/litho-multipanel/hero-main.jpg',
  ...
  },
  {
    name: 'Lithophane Box',
    sku: 'LITHBOX03',
    description: 'A four-sided lithophane box with a removable lid. Upload your photos to create a glowing keepsake box.',
    price: 45.0,
  ...
  {
    name: 'Five-Sided Lithophane Panel Box',
    sku: 'LITHBOX05',
    description: 'A five-sided lithophane panel box with a removable lid. Upload your photos to create a glowing keepsake box.',
    price: 55.0,
    image: '/images/products/litho-box/hero-main.jpg',
    imageGallery: [
      '/images/products/litho-box/hero-main.jpg',
  ...
  {
    name: 'Lithophane Globe Lamp',
    sku: 'LITHGLB04',
    description: 'Globe-style lithophane lamp made from your photos. Upload your images to create a glowing sphere.',
    price: 50.0,
    ...
    imageGallery: [
      ...
      '/images/products/litho-lamp/process-print.jpg',
      '/images/products/litho-lamp/process-led.jpg',
    ],
    brand: 'HexForge Labs',
    stock: 999,
    categories: ['lamps', 'custom'],
  ...
  {
    name: 'Lithophane Diffuser Insert',
    sku: 'LITHDF01',
    description: 'Standalone diffuser insert for lithophane lamps. Adds soft, even ambient glow without custom image uploads.',
    price: 24.99,
    image: '/images/products/litho-box/hero-main.jpg',
    imageGallery: ['/images/products/litho-box/hero-main.jpg'],
    brand: 'HexForge Labs',
    stock: 999,
    categories: ['lamps', 'accessories'],
  },
  {
    name: 'Lithophane Night Light',
    sku: 'LITHNL01',
    description: 'Standalone night light with warm ambient illumination. Simple plug-and-play accessory with no custom image upload required.',
    price: 29.99,
    image: '/images/products/litho-lamp/hero-main.jpg',
    imageGallery: ['/images/products/litho-lamp/hero-main.jpg'],
    brand: 'HexForge Labs',
    stock: 999,
    categories: ['lamps', 'accessories'],
  },
